        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ Auth::user()->role === 'admin' ? route('dashboard') : route('staff.dashboard') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->role === 'staff')
                        ...
                        <x-nav-link :href="route('staff.routes.index')" :active="request()->routeIs('staff.routes.*')">
                            {{ __('My Routes') }}
                        </x-nav-link>
                        @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->role === 'admin')
                ...
                <x-responsive-nav-link :href="route('admin.purchase_orders.index')" :active="request()->routeIs('admin.purchase_orders.*')">
                    {{ __('Purchase Orders') }}
                </x-responsive-nav-link>
